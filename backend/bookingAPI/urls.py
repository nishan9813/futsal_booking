...
from .views import BookingViewSet, ground_time_slots, booked_time_slots, owner_booking_history, user_booking_history
...
urlpatterns = router.urls + [
    ...
    path('owner-history/', owner_booking_history, name='owner-booking-history'),
]
