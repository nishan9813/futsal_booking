...
#             # All three fields must be present to change password
#             if not old_password:
...
#                 raise serializers.ValidationError({"new_password_confirm": "Please confirm your new password."})

#             if not user.check_password(old_password):
#                 raise serializers.ValidationError({"old_password": "Old password is incorrect."})

#             if new_password != new_password_confirm:
#                 raise serializers.ValidationError({"new_password_confirm": "New password fields do not match."})
...
#         # Remove password fields from validated_data so we can handle separately
