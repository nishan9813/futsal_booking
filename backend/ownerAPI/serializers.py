...
class GroundImageSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        read_only_fields = ['id', 'uploaded_at']  # allow 'image' to be writable



class GroundSerializer(serializers.ModelSerializer):
    ground_images = GroundImageSerializer(many=True, read_only=True)
...
class OwnerProfileSerializer(serializers.ModelSerializer):
    ...
    grounds = GroundSerializer(many=True)  # Accept nested grounds input
    ...
    def create(self, validated_data):
        ...
        user_data.pop('confirm_password', None)  # remove confirm password if present
        ...
        # Create grounds associated with this owner
        for ground_data in grounds_data:
            Ground.objects.create(owner=owner_profile, **ground_data)
